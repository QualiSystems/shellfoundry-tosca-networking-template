...
### **{{cookiecutter.display_name}}**
**{{cookiecutter.display_name}}** shell provides you with connectivity and management capabilities such as device structure discovery and power management for the resource. 

For more information on the device, see the vendor's official product documentation.

### Standard version
**{{cookiecutter.display_name}}** is based on the Networking Shell Standard version **{{cookiecutter.standard_version}}**.
...
▪ CloudShell version **{{cookiecutter.server_version}}**
...
The **{{cookiecutter.display_name}}** shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 
...
This section describes how to import the **{{cookiecutter.display_name}}** shell and configure and modify the shell’s devices.
...
1. Download the *{{cookiecutter.deps_name}}.zip* file, see [Downloading the Shell](#downloading-the-shell).
